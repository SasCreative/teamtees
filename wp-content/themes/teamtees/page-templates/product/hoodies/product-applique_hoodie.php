<div id="product_tab" class="product_tab_p">
                <div class="container">
                    <div class="row">
                        <div class="col-md-6">
                            <div id="hoodies_tow" class="carousel slide carousel-fade"
                                data-ride="carousel">
                                <ol class="carousel-indicators">
                                    <li data-target="#hoodies_tow" data-slide-to="0" class="active">
                                        <img src="<?php echo get_template_directory_uri(); ?>/img/TT hoodie Blue Yellow.png"
                                            class="d-block w-100" alt="...">
                                        black
                                    </li>
                                    <li data-target="#hoodies_tow" data-slide-to="1">

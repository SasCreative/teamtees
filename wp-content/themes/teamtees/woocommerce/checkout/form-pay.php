	...
	<table class="shop_table">
		<thead>
			<tr>
				...
				<th class="product-quantity"><?php esc_html_e( 'Qty', 'teamtees' ); ?></th>
				<th class="product-total"><?php esc_html_e( 'Totals', 'teamtees' ); ?></th>
			</tr>
		</thead>
		<tbody>
